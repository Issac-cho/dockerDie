...
<%!
    ...
    String dbUrl = "jdbc:mariadb://10.0.2.30:3306/guestbookDB";
...
<style>
    ...
    * {
    ...
    html, body {
        ...
        color: #FF3333; /* #00FF88 -> #FF3333 (밝은 빨강) */
    ...
    .screen-noise {
        ...
        width: 100%;
        height: 100%;
        background-image: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="200" height="200"><filter id="noise"><feTurbulence type="fractalNoise" baseFrequency="0.9" numOctaves="4" stitchTiles="stitch"/></filter><rect width="100%" height="100%" filter="url(%23noise)" opacity="0.1"/></svg>'); 
        opacity: 0.3; 
        pointer-events: none;
    ...
    .screen-curvature {
        ...
        background: 
            ...
            radial-gradient(ellipse at top, transparent 0%, rgba(0, 0, 0, 0.08) 50%), 
            radial-gradient(ellipse at bottom, transparent 0%, rgba(0, 0, 0, 0.08) 50%); 
        box-shadow: 
    ...
    .screen-bezel {
        ...
        box-shadow: 
            ...
            0 0 100px rgba(255, 0, 0, 0.15); /* 녹색 -> 빨강 */
    ...
    .particle {
        ...
        width: 2px;
        height: 2px;
        background: #FF0000; /* 녹색 -> 빨강 */
        border-radius: 50%;
        opacity: 0.6;
        animation: float 15s infinite ease-in-out;
        box-shadow: 0 0 6px #FF0000; /* 녹색 -> 빨강 */
    }
    ...
    .form-container {
        ...
        left: 50%;
        transform: translate(-50%, -50%);
        background: linear-gradient(135deg, rgba(255, 0, 60, 0.15) 0%, rgba(10, 10, 10, 0.85) 100%); /* 녹색 틴트 -> 빨강 틴트 */
        padding: 30px;
        border-radius: 10px;
        z-index: 10;
        border: 2px solid #FF3333; /* 녹색 -> 빨강 */
        box-shadow: 
            0 0 20px #FF3333,
            0 0 40px rgba(255, 0, 60, 0.4),
            inset 0 0 20px rgba(255, 0, 60, 0.15);
    ...
    @keyframes titleGlow {
        ...
        to { text-shadow: 0 0 20px #FF3333, 0 0 30px #FF3333; }
    }
    ...
    .form-container textarea:focus {
        border-color: #FF5555; /* 더 밝은 빨강 */
        box-shadow: 
            0 0 15px rgba(255, 0, 60, 0.6),
            inset 0 0 10px rgba(255, 0, 60, 0.15);
    ...
    .form-container button {
        width: 100%;
        padding: 12px;
        background: linear-gradient(135deg, #FF0000 0%, #CC0000 100%); /* 녹색 그라데이션 -> 빨강 그라데이션 */
        color: #000;
        border: none;
        border-radius: 5px;
        cursor: pointer;
...
<body>
    ...
    <div class="form-container">
        <h2>THE CHAOS</h2> <h3>고요 속의 외침...</h3>
    ...
    <script>
        ...
        class PixelTrail {
            ...
            createPixel(x, y, dx, dy) {
                ...
                // 색상 변화 (빨간색 계열)
                const hue = 0 + Math.random() * 20; // 0-20 (Red to Orange-ish)
        ...
        function initCRTEffects() {
            ...
            setInterval(() => {
                ...
                if (noise) {
                    noise.style.opacity = (0.2 + Math.random() * 0.2).toString(); 
                }
            }, 300); 
            ...
            setInterval(() => {
                if (Math.random() > 0.9) { 
                    document.body.style.transform = 'perspective(1000px) rotateX(2deg) translateX(' + (Math.random() - 0.5) * 4 + 'px)'; 
                    setTimeout(() => {
        ...
        window.addEventListener('DOMContentLoaded', function() {
            ...
            inputs.forEach(input => {
                input.addEventListener('keydown', function() {
                    this.style.boxShadow = '0 0 20px rgba(255, 0, 0, 0.8)'; // 녹색 -> 빨강
                });
